        ...
        <section className="pb-section" id="about-me">
            <div className="container" ref={container}>
                <h2 className="text-4xl md:text-6xl font-thin mb-20 slide-up-and-fade">
                   I focus on building solutions that prioritize users at every step. My approach is not just about writing clean code, but about creating systems that are reliable, scalable, and tailored to the exact needs of the people who use them
                </h2>
