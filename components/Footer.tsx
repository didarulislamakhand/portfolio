        ...
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    ...
                    <a href='https://www.tajmirul.site/' target='_blank' className="leading-none text-muted-foreground hover:underline hover:text-white">
                        Design & built by Tajmirul Islam <br />
                        Revised by Didarul Islam Akand
